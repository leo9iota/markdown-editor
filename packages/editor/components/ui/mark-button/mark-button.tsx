...
// --- Tiptap UI ---
import type { Mark, UseMarkConfig } from '../../../components/ui/mark-button/index';
import { MARK_SHORTCUT_KEYS, useMark } from '../../../components/ui/mark-button/index';
// --- Hooks ---
      ...
      >
        {children ?? (
          <>
            ...
            {showShortcut && <MarkShortcutBadge shortcutKeys={shortcutKeys} type={type} />}
          </>
        )}
      </Button>
    );
